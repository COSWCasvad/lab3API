...
var AppComponent = (function () {
    function AppComponent(modalService, authService, userService) {
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__ng_bootstrap_ng_bootstrap__["b" /* NgbModal */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__common_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__common_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UserService */]) === "function" && _c || Object])
], AppComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_user_edit_page_user_edit_page_component__ = __webpack_require__("../../../../../src/app/pages/user-edit-page/user-edit-page.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_user_list_page_user_list_page_component__ = __webpack_require__("../../../../../src/app/pages/user-list-page/user-list-page.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_users_service__ = __webpack_require__("../../../../../src/app/services/users.service.ts");
...
var ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_17__pages_sign_in_sign_in_page_component__["a" /* SignInPageComponent */] },
    ...
    { path: 'editUser', component: __WEBPACK_IMPORTED_MODULE_9__pages_user_edit_page_user_edit_page_component__["a" /* UserEditPageComponent */] },
    { path: 'users', component: __WEBPACK_IMPORTED_MODULE_10__pages_user_list_page_user_list_page_component__["a" /* UserListPageComponent */] },
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__pages_user_edit_page_user_edit_page_component__["a" /* UserEditPageComponent */],
            __WEBPACK_IMPORTED_MODULE_10__pages_user_list_page_user_list_page_component__["a" /* UserListPageComponent */]
        ],
        imports: [
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_12__services_todo_service__["a" /* TodoService */], __WEBPACK_IMPORTED_MODULE_13__services_users_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_15__common_config_app_configuration_service__["a" /* AppConfiguration */], __WEBPACK_IMPORTED_MODULE_18__common_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_19__common_app_data_service__["a" /* AppDataService */]
        ],
...
APIService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__common_config_app_configuration_service__["a" /* AppConfiguration */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__common_config_app_configuration_service__["a" /* AppConfiguration */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */]) === "function" && _b || Object])
], APIService);
...
var User = (function () {
    function User(username, password, email, firstname, lastname, image) {
...
var SignInPageComponent = (function () {
    function SignInPageComponent(appComponent, formBuilder, usersService, router) {
        this.appComponent = appComponent;
        this.formBuilder = formBuilder;
        this.usersService = usersService;
        this.router = router;
        this.signInForm = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["f" /* FormGroup */]({
            username: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* FormControl */](),
            password: new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["g" /* FormControl */]()
        });
    }
    ...
    SignInPageComponent.prototype.isLoggedIn = function () {
...
SignInPageComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__app_component__["a" /* AppComponent */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__app_component__["a" /* AppComponent */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* FormBuilder */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UserService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _d || Object])
], SignInPageComponent);
...
var UserEditPageComponent = (function () {
    ...
    UserEditPageComponent.prototype.onSubmit = function () {
        var _this = this;
        this.userService.create(this.userForm.get('username').value, this.userForm.get('password').value, this.userForm.get('email').value, this.userForm.get('name').value, this.userForm.get('lastname').value, this.userForm.get('image').value).subscribe(function (response) {
            _this.router.navigate(['users']);
        }, function (error) {
            _this.userError = 'Error agregando usuario: ' + (error && error.message ? error.message : '');
        });
    };
...
UserEditPageComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UserService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* FormBuilder */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _c || Object])
...
var UserService = (function (_super) {
    ...
    function UserService(config, http, authService) {
        ...
        _this.users = [
            new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */]("", "", "", "Michael", "Jackson", "https://www.thefamouspeople.com/profiles/images/michael-jackson-3.jpg"),
            new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */]("", "", "", 'Scarlett', "Johansson", "http://www.myfilmviews.com/wp-content/uploads/2012/12/scarlett_johansson.jpg"),
            new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */]("", "", "", 'Brad', "Pitt", "http://cdn.glamour.es/uploads/images/thumbs/201238/las_50_caras_de_brad_848381170_667x1000.jpg")
        ];
        return _this;
    }
    ...
    UserService.prototype.create = function (username, password, email, name, lastName, image) {
        //this.users.push(new User(name, lastName, image));
        return this.post(this.resourceUrl, new __WEBPACK_IMPORTED_MODULE_1__models_user__["a" /* User */](username, password, email, name, lastName, image));
    };
...
UserService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* Injectable */])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__common_config_app_configuration_service__["a" /* AppConfiguration */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__common_config_app_configuration_service__["a" /* AppConfiguration */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_http__["b" /* Http */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__common_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__common_auth_service__["a" /* AuthService */]) === "function" && _c || Object])
], UserService);
